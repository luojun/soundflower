"""Pygame visualizer for the new decoupled simulation architecture."""

import pygame
import numpy as np
import math
from typing import Dict, Any, Optional
from soundflower.simulation_loop import VisualizationLoop


class PygameVisualizerV2:
    """Pygame visualizer that works with the decoupled simulation loop."""
    ...
    def render_callback(self, render_data: Dict[str, Any]) -> bool:
        ...
        Args:
            render_data: Render data from visualization loop
